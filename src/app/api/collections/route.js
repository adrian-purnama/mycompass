...
export async function POST(request) {
  try {
    ...
    const { connectionString, connectionId, organizationId, databaseName, includeCounts = true } = body || {};
    ...
    const collections = await listCollections(finalConnectionString, databaseName, includeCounts);
